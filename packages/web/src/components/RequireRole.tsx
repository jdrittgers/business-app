...
export default function RequireRole({ children, allowedRoles }: RequireRoleProps) {
  ...
  const hasPermission = user.businessMemberships.some(membership =>
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-xl p-8 max-w-md text-center">
          ...
          <p className="text-gray-600 mb-4">
            You don't have permission to access this page. Contact your business owner if you need access.
          </p>
          <button
