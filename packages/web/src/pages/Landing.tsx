...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: 'linear-gradient(135deg, #0f172a 0%, #1e293b 50%, #0f172a 100%)' }}>
      ...
      <div className="border-b border-white/10">
        <div className="max-w-6xl mx-auto px-4 py-5">
          <div className="flex items-center space-x-3">
            <img src="/kernelag-logo.jpg" alt="KernelAg" className="w-10 h-10 rounded-xl object-cover ring-2 ring-white/20" />
            <div>
              <h1 className="text-xl font-bold text-white">KernelAg</h1>
              <p className="text-xs text-slate-400">Agricultural Business Platform</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Main Content */}
      <div className="flex-1 flex flex-col justify-center max-w-6xl mx-auto px-4 py-12 w-full">
        {/* Hero Section */}
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          {/* Farmer Card */}
          <div className="bg-white rounded-xl shadow-2xl overflow-hidden hover:shadow-emerald-500/10 transition-shadow">
            <div className="p-6">
              ...
              <button
                ...
                className="w-full py-3 px-6 bg-emerald-500 text-white rounded-lg font-semibold hover:bg-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 transition-colors flex items-center justify-center space-x-2"
              >
          ...
          {/* Retailer Card */}
          <div className="bg-white rounded-xl shadow-2xl overflow-hidden hover:shadow-indigo-500/10 transition-shadow">
            <div className="p-6">
              <div className="flex items-center space-x-4 mb-6">
              ...
              <button
                ...
                className="w-full py-3 px-6 bg-indigo-600 text-white rounded-lg font-semibold hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition-colors flex items-center justify-center space-x-2"
              >
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-xl border border-white/10 p-6">
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <h4 className="font-semibold text-white mb-1">Try the Demo</h4>
              <p className="text-sm text-slate-400 mb-3">
                Explore all features with our demo account - no registration required.
              </p>
              <div className="flex flex-wrap gap-3">
                <div className="inline-flex items-center px-3 py-1.5 bg-white/10 rounded-lg text-sm">
                  <span className="text-slate-400 mr-2">Email:</span>
                  <span className="font-mono font-medium text-white">demo@demo.com</span>
                </div>
                <div className="inline-flex items-center px-3 py-1.5 bg-white/10 rounded-lg text-sm">
                  <span className="text-slate-400 mr-2">Password:</span>
                  <span className="font-mono font-medium text-white">demo</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-6xl mx-auto px-4 py-4">
          <p className="text-center text-sm text-slate-500">
            &copy; {new Date().getFullYear()} KernelAg. All rights reserved.
          </p>
        </div>
      </div>
    </div>
