              ...
              {!editingItem && (
                <div>
                  ...
                  <select
                    ...
                    onChange={e => {
                      const selectedChemical = chemicals.find(c => c.id === e.target.value);
                      setItemForm(prev => ({
                        ...prev,
                  ...
                  >
                    ...
                    {chemicals.map(c => (
                      <option key={c.id} value={c.id}>
                        {c.name} (${c.pricePerUnit}/{c.unit})
                        {c.defaultRatePerAcre ? ` - Default: ${c.defaultRatePerAcre} ${c.rateUnit || c.unit}/ac` : ''}
                      </option>
                    ))}
                  </select>
                </div>
